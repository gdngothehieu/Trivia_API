...
def create_app(test_config=None):
    ...
    def get_questions():
        ...
        return jsonify({
            ...
            'categories': categories_dict,
            'current_category': categories_dict[current_questions[0]['category']]
        })
    ...
    def new_question():
        ...
        the_question = body.get('question')
        ...
        try:
            if search_term:
                ...
                current_question = Question.query.order_by(Question.id.desc()).first()
                ...
                return jsonify({
                    ...
                    'current_category': categories_dict[current_question.category]
                })

            else:
                question = Question(question=the_question, answer=answer,
    ...
    def get_by_category_id(cid):
        ...
        category = Category.query.filter(Category.id == cid).first()
    ...
    def play_quizzes():
        ...
        try:
            if quiz_category['id'] == 0:
                question = random.choice(Question.query.filter(Question.id.notin_(previous_questions)).all())
